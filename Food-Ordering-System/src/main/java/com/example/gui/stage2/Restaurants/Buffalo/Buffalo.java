package com.example.gui.stage2.Restaurants.Buffalo;
...
public class Buffalo extends Restaurant implements Menu {

    public Buffalo(){}

    public Buffalo(String name, String address, String contactInfo, double rating){

        super(name,address,contactInfo,rating);
    }

    public void savebuffaloitem(String name, String price, String description,String img, String fileName) {
        try {
            String packagePath = "src/main/java/com/example/gui/stage2/Restaurants/Buffalo";
